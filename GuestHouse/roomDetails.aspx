<%@ Page Language="C#" AutoEventWireup="true" CodeFile="roomDetails.aspx.cs" Inherits="roomDetails" %>
    ...
    <div class="container-fluid">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" id="formnew" style="display:none;">
            <h2 class="sub-header">Enter Room Details</h2>
					<form role="form" id="formnew" action="#" method="post">
					  ...
					  <div class="form-group">
						...
						<input type="number" class="form-control"  nsme="rate" id="rate" placeholder="Write per day rate in INR" required>
					  </div>
					  <div class="form-group">
